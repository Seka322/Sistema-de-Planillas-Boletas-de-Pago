...
class Login extends CI_Controller
{
    ...
    public function index()
    {
        ...
        else
        {
            ...
            $this->form_validation->set_message('required', '<div class="alert alert-danger" style="margin-top: 3px">
              <div class="header"><b><i class="fa fa-exclamation-circle"></i> {field}</b> debe ser ingresado</div></div>');
            ...
            if ($this->form_validation->run() == TRUE)
            {
                ...
                $checking = $this->admin->check_login('administradores', array('usuario' => $username), 
                ...
                else
                {
                    $data['error'] = '<div class="alert alert-danger" style="margin-top: 3px">
                        ...
                        Usuario y/o contraseña incorrectos o el Usuario esta Inactivo!</div></div>';
    ...
    {
        // obtener datos flash
        echo $this->session->flashdata('flash_welcome');
    }
    function logout()
    {
